...
public class UIManager : MonoBehaviour
{
    ...
    [Header("MenuMult")]
    public GameObject MenuMultiSelect;

    [Header("Games")]
    public GameObject MainStage;
    public GameObject MultiStage;
    ...
    public void ToHome()
    {
        ...
        MenuStart.SetActive(false);
        MenuMultiSelect.SetActive(false);
        MainStage.SetActive(false);
        MultiStage.SetActive(false);
    }
   ...
   public void ToMultiSelect()
    {
        MenuStart.SetActive(false);
        MenuMultiSelect.SetActive(true);
    }

    public void ToMulti_Host()
    {
        MenuMultiSelect.SetActive(false);
        MenuInGame.SetActive(true);
        MultiStage.SetActive(true);
    }

    public void ToMulti_Client()
    {
        MenuMultiSelect.SetActive(false);
        MenuInGame.SetActive(true);
        //별도 집게 컨트롤용도 true
